...
qq_groups = ["655188278"]  # 监控的qq群 643920453
qq_groups_user = [ "2547496916"]  # 指定qq群的人

keystring = {"地学之光第", "长江讲坛第", "讲座将在会后发放凭证", "https://docs.qq.com/form/page/"}
...
question_type_table = {"姓名": "input", "学号": "input", "班级": "click", "是否能准时参加": "click", "是否确保能准时参加会议": "click"}
